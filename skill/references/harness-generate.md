...
- *`build.gradle.kts` / `package.json` / `pyproject.toml` (stack and versions)*
- *2–3 ViewModel or state-holding classes (architecture patterns)*
- *2–3 UI files / screens / components (UI conventions)*
- *1–2 DI modules (injection approach)*
- *1–2 test files (test conventions)*
- *Any existing `.editorconfig`, `.cursorrules`, or `CLAUDE.md`"*
